...
<head>
    ...
    <!-- Title Page-->
    <title>Data Angsuran Piutang</title>
 ...
 <!-- MAIN CONTENT-->
                             ...
                             <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Data Angsuran Piutang</strong>
                                    </div>
										...
										<div class="col-sm-12 col-md-12">
                                            <div class="row form-group">
												...
												<div class="col-12 col-md-9">
													<input type="hidden" id="id_piutang" name="id_piutang" placeholder="" class="form-control" value="<?php echo $_GET['id_piutang'] ?>"/>
												</div>
                                            </div>
                                             <div class="row form-group">
								...
								if(isset($_POST['save'])){
								  ...
								  if($angsuran>$sisa){
									  ...
									  $save=mysqli_query($connect, "INSERT INTO angsuran_piutang VALUES(' ','$_POST[id_piutang]','$tanggal','$angsuran')");
									  echo"<script language=javascript>
										window.location='?p=angsurpiutang&id_piutang=".$_POST['id_piutang']."';
										</script>";
										exit;
								  }
      ...
      <div class="col-12">
        ...
        <div align="margin-right: 4px;">
			<?php
            echo "<a href='printangsurp.php?id_piutang=".$_GET['id_piutang']."'><button type='button' class='au-btn au-btn-icon au-btn--green au-btn--small'>CETAK PDF</button></a>";
			?>
		</div>
        </div> 
			<br />
