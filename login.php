                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <!--<div class="login-logo">
                            <a href="#">
                                <img src="images/icon/fsindonesia.jpg" alt="CoolAdmin">
                            </a>
                        </div>-->
						<br />
						<div class="text-center">
						<h2 class="h2 text-black-900 mb-1">FS INDONESIA</h2>
						</div> <br />
                        <div class="login-form">
                            <form action="proseslogin.php" method="post" class="login100-form validate-form">
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" name="masuk" type="submit">Masuk</button>
								<br />
                            </form>
                        </div>
                    </div>
