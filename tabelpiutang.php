                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive table--no-card m-b-50">
                                            <table id="example" class="table table-borderless table-striped table-earning">
                                                ...
                                                <tbody>
                                                     <?php
                                              $query = mysqli_query($connect, "SELECT * FROM data_piutang WHERE status='Ada'");
                                                $no=1;
                                                                            
                                                while ($piutang = mysqli_fetch_array($query, MYSQLI_ASSOC)){
                                                    ...
                                                    <tr>
														...
														<a href="angsurpiutang.php?p=angsurpiutang&id_piutang=<?php echo $piutang['id_piutang']; ?>">
														<i class='zmdi zmdi-balance-wallet'></i>
														</a></button>
                                                        <?php 
                                                            echo "<button class='item' data-toggle='tooltip' data-placement='top' title='Delete'>
                                                                    <a href='hapuspiutang.php?id_piutang=".$piutang['id_piutang']."' onclick=\"return confirm('Yakin Hapus Piutang')\">
                             ...
                             <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="printpiutang.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="row">
                             <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Formulir Data piutang</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="prosespiutang.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                             <div class="row form-group">
                                                <div class="col col-md-3">
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" pattern="[0-9]+" id="no_tlpn" name="no_tlpn" placeholder="Masukan No. Telepon" class="form-control" required>
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
